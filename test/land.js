...
contract("Land", function(accounts){
    ...
    let landReginstance;
    const landInspector = accounts[0];
    ...
    it("allows a seller to register", function() {
        return Land.deployed().then(function(instance) {
            landReginstance = instance;
            return landReginstance.registerSeller("Vrinda", 20, "abc", "tin1234567", "many" , "QmYdztkcPJLmGmwLmM4nyBfVatoBMRDuUjmgBupjmTodAP", {from: seller});
