...
class updateBuyer extends Component {
  ...
  componentDidMount = async () => {
    ...
    try {
      ...
      const buyer_verify = await this.state.LandInstance.methods.isVerified(currentAddress).call();
      ...
      console.log(buyer);
      console.log(buyer[0]);
      this.setState({ name: buyer[0], age: buyer[5], city: buyer[1], email: buyer[4], ghanaCardNumber: buyer[6], tinNumber: buyer[2] });
      buyerTable.push(
        <Row>
          <Col md="12">
            <FormGroup>
  ...
  updateBuyer = async () => {
    if (this.state.name === '' || this.state.age === '' || this.state.city === '' || this.state.email === '' || this.state.ghanaCardNumber === '' || this.state.tinNumber === '') {
      alert("All the fields are compulsory!");
    } else if (this.state.ghanaCardNumber.length !== 12) {
                        ...
                        <Col md="12">
                          <FormGroup>
                            ...
                            <Input
                              ...
                              onChange={this.updateGhanaCardNumber}
                            />
                          </FormGroup>
                        </Col>
                      </Row>
