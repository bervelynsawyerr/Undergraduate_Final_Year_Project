...
//Get network provider and web3 instance
            ...
            const registered = await this.state.LandInstance.methods.isSeller(currentAddress).call();
                                    ...
                                    <Col lg="4">
                                        <div className="dashbord dashbord-orange">
                                            <div className="icon-section">
                                                ...
                                                <medium>Registered Lands Count</medium>
                                                <br/>
                                                <p>{countarr}</p>
                                            </div>
                                            <div className="detail-section"><br/>
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <div className="chart-area">
                                        ...
                                        <Button href="/Seller/AddLand" disabled={!this.state.verified}
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <div className="chart-area">
                                        ...
                                        <Button href="/Seller/ApproveRequest" disabled={!this.state.verified}
                                                className="btn-fill" color="primary">
