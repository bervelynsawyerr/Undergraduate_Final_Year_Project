...
class updateSeller extends Component {
    ...
    componentDidMount = async () => {
        ...
        try {
            ...
            this.setState({
                name: seller[0],
                age: seller[1],
                ghanaCardNumber: seller[2],
                tinNumber: seller[3],
                landsOwned: seller[4]
            });
            //sellerTable.push(<div><p>Name: {seller[0]}</p><p>Age: {seller[1]}</p><p>Ghana Card Number: {seller[2]}</p><p>Pan Number: {seller[3]}</p><p>Owned Lands: {seller[4]}</p></div>);
            sellerTable.push(
                <Row>
                    <Col md="12">
                        <FormGroup>
    ...
    updateSeller = async () => {
        ...
        } else if (this.state.ghanaCardNumber.length !== 10) {
