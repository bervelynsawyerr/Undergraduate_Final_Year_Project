    ...
    componentDidMount = async () => {
        ...
        try {
            ...
            for (let i = 0; i < sellersCount; i++) {
                const seller = await this.state.LandInstance.methods.getSellerDetails(sellersMap[i]).call();
                console.log(seller);
                const seller_verify = await this.state.LandInstance.methods.isVerified(sellersMap[i]).call();
                console.log(seller_verify);
                seller.verified = seller_verify;

                //seller.push(seller_verify);
                const not_verify = await this.state.LandInstance.methods.isRejected(sellersMap[i]).call();
                ...
                sellerTable.push(<tr>
                    ...
                    <td>{seller[3]}</td>
                    <td>{seller[4]}</td>
                    <td><a href={`https://ipfs.io/ipfs/${seller[5]}`} target="_blank">Click Here</a></td>
                    ...
                    <td>
                        <Button
                            onClick={this.NotifySeller(sellersMap[i])}
                            disabled={seller_verify || not_verify}
