...
class RegisterBuyer extends Component {
    ...
    RegisterBuyer = async () => {
        ...
        if (this.state.name === '' || this.state.age === '' || this.state.city === '' || this.state.ghanaCardNumber === '' || this.state.region === '') {
            alert("All the fields are compulsory!");
        } else if (!Number(this.state.ghanaCardNumber)) {
            alert("GhanaCardNumber Number should be 12 digits long!");
        } else if (this.state.region.length !== 10) {
                    ...
                    <div className="auth-inner">
                        <div className="App">
                            ...
                            <div className="form">
                                ...
                                <FormGroup>
                                    <label>Add your GhanaCardNumber Card (PDF Format)</label>
                                    <FormFile
                                        id="File2"
